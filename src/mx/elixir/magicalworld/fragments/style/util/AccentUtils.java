 ...
 */
package mx.elixir.magicalworld.fragments.style.util;
...
import mx.elixir.magicalworld.R;
...
public final class AccentUtils {
    ...
    private static final String METADATA_COLOR = "elixir_theme_accent_preview";
    private static final String METADATA_SUPPORTED_STYLES = "elixir_theme_accent_supported_styles";
